...
const Kidsglasses=()=>{
    ...
    const loadData=()=>{
        let url="http://localhost:8080/cards/kidsglass";
    ...
    const filteredData = ewdata.filter(item => item.category === 'kids');
    ...
    return(
        <>
          <h1 style={{textAlign:"center" , backgroundColor:"#a6f7e2" , marginTop:"10px" ,  fontFamily:"cursive"}}>Kids Glassess</h1>
