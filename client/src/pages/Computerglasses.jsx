...
const Computerglasses=()=>{
    ...
    const loadData=()=>{
        let url="http://localhost:8080/cards/computerglasses";
    ...
    const filteredData = ewdata.filter(item => item.category === 'Computerglasses');
    const ans=ewdata.map((key)=>{
    ...
    return(
        <>
          <h1 style={{textAlign:"center" , backgroundColor:"#a6f7e2" , marginTop:"10px" ,  fontFamily:"cursive"}}>Computer Glassess</h1>
